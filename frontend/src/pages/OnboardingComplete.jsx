        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-white text-opacity-90 mb-4">
              Your first insights will be ready within 24 hours. We&apos;ll send
              you an email when your dashboard is populated with data and ready
              to roll!
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 mb-8 border border-gray-100">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(30, 139, 139, 0.1), rgba(198, 222, 65, 0.1))",
                }}
              >
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Track how often AI models mention your brand across different
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  See how you stack up against competitors in AI-generated
                  responses
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              We will email you to let you know elelem&apos;s Content
              Intelligence engine has finished analysis and then you can:
            </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    elelem will rank prompts by popularity or identify gaps to
                    fill to lay out next clear steps
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Receive recommendations on how to improve your AI visibility
                    as an actionable brief or 1st draft in your tone and style
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Transparently see the impact your optimization is having on
        ...
        {loading && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-white bg-opacity-80">
            <div className="flex flex-col items-center">
              ...
              <div className="text-2xl font-bold text-[#1E8B8B] mb-2">
                Completing onboarding...
              </div>
              <div className="text-gray-600">
                Hang tight while we complete your dashboard configuration!
              </div>
            </div>
          </div>
        )}
