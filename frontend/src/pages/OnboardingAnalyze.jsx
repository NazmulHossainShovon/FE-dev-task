...
export default function OnboardingAnalyze() {
  ...
  const getBusinessLogic = async () => {
    ...
    fetch(
      `${BACKEND_URL}/api/v1/business-logic/get-started?onboardingId=${onboardingId}`,
      {
        method: "POST",
        ...
        <div className="px-8 mb-8 flex justify-center">
          <div className="w-full max-w-md">
            <Button
              variant="ghost"
              onClick={() =>
                navigate(createPageUrl("Onboarding") + `?id=${onboardingId}`)
              }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Former Editor in Chief at Reuters
                </p>
              </div>
            </div>
          </div>
