  ...
  const handleAddVariant = () => {
    ...
    setBrand((prevBrand) => ({
      ...
      brand_name_variations: [
        ...prevBrand.brand_name_variations,
        newVariantName.trim(),
      ],
    }));
    setNewVariantName("");
        ...
        <div className="flex-1 flex items-start justify-center px-8 py-12 overflow-y-auto">
          <div className="w-full max-w-md">
            ...
            <p className="text-gray-600 mb-8">
              We found your brand name and product names. Add or remove as
              needed.
            </p>
          ...
          >
            ...
            <div className="bg-white rounded-xl p-6 mb-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Sisu Clinic is a doctor-led aesthetic medicine destination
                offering a comprehensive range of the world&apos;s most advanced
                beauty treatments.
              </p>
            </div>
